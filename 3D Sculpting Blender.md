...
4. In viewpoint, switch to `Front Orthographic` to adjust the jaw and center it.
...
After some more skull shaping with the `crease brush at 100px`, it now might look more like a real skull:
...
For animation, see: `Examples/Skull-Animation.gif`
