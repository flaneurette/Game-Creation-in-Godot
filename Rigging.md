...
### Part A: Prepare your skeleton model (once)
...
### Part B: Get an animation from Mixamo
...
### Part C: Save the animation as a file
...
### Part D: Add it to your model's scene
...
###  Part E: If the skeleton doesn't move
